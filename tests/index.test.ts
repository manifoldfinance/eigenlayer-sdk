...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('default logLevel is warn', async () => {
      const client = new Xga({ apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Xga({ logger: logger, apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
  ...
  describe('baseUrl', () => {
    ...
    test('env variable with environment', () => {
      ...
      expect(
        () => new Xga({ apiKey: 'My API Key', bearerToken: 'My Bearer Token', environment: 'production' }),
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Xga({ maxRetries: 4, apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Xga({ apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['XGA_BEARER_TOKEN'] = 'My Bearer Token';
    const client = new Xga();
  ...
  test('with overridden environment variable arguments', () => {
    ...
    process.env['XGA_BEARER_TOKEN'] = 'another My Bearer Token';
    const client = new Xga({ apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
    expect(client.apiKey).toBe('My API Key');
    expect(client.bearerToken).toBe('My Bearer Token');
  });
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Xga({ apiKey: 'My API Key', bearerToken: 'My Bearer Token', fetch: testFetch });
