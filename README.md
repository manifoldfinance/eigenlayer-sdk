# Xga TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/xga.svg?label=npm%20(stable)>)](https://npmjs.org/package/xga) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/xga)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install xga`
...
1. Via the `XGA_LOG` environment variable
