...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['XGA_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['XGA_LOG'] or 'warn' if it isn't set.
   */
...
export class Xga {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('XGA_LOG'), "process.env['XGA_LOG']", this) ??
      defaultLogLevel;
  ...
  static XgaError = Errors.XgaError;
